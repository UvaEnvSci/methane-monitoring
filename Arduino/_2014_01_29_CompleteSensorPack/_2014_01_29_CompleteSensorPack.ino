...
Version : 8.0 - Switch between AREFs for battery and for gas sensor.
Date    : 2014-03-01
...
void loop()
{
  ...
  {  
    ...
    snprintf ( message, 88, "http://methanemonitoring.appspot.com/log?ID=%d&T=%d&rH=%d&CH4=%d&P=%d&Batt=%d", ID, AvTInt, AvrHInt, gasVal, PInt, voltageInt);
