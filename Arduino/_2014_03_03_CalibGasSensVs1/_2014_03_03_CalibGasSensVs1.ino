/*
Sketch written for rH & T calibration of the gas sensor.
Reads data continuously from SHT15, BMP180, TGS2600, every 30 seconds.
Reads battery status, save data to SD, send to XBee.

Based on 2014_03_01_CompleteSensorPackVs8.
First Version made 2014.03.03 by Michael van den Bossche
*/
...
int tcycle                = 30;              // time for one meas cycle (in s, 10 minutes).
...
void loop()
{
  ...
  snprintf ( message, 88, "localhost:8080/log?T=%d&rH=%d&CH4=%d&P=%d&Batt=%d", measTInt, measrHInt, gasVal, PInt, voltageInt);
